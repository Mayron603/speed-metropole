...
export default function Home() {
  return (
    <div className="flex flex-col">
      ...
      <section id="about" className="w-full py-16 md:py-24 bg-background">
        <div className="container px-4 md:px-6">
          ...
          <div className="mx-auto grid items-start gap-8 sm:max-w-4xl sm:grid-cols-1 md:gap-12 lg:max-w-5xl lg:grid-cols-3 mt-12">
            <Card className="shadow-lg hover:shadow-xl transition-shadow bg-card/50 hover:bg-card">
      ...
      <section id="divisions" className="w-full py-16 md:py-24 bg-secondary/20">
        ...
        <div className="container">
          <div className="grid gap-10 px-10 md:gap-16 lg:grid-cols-2">
            <div className="space-y-4">
              <div className="inline-block rounded-lg bg-secondary px-3 py-1 text-sm text-secondary-foreground font-semibold">Junte-se a Nós</div>
